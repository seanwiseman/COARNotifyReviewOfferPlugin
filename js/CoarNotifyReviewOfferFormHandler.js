/**
 * @file js/CoarNotifyReviewOfferFormHandler.js
 *
 * Copyright (c) 2014-2019 Simon Fraser University
 * Copyright (c) 2000-2019 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @package plugins.generic.coarNotifyReviewOffer
 * @class CoarNotifyReviewOfferFormHandler
 *
 * @brief Coar Notify Review Offer form handler.
 */
(function ($) {

    /** @type {Object} */
    $.pkp.controllers.form.coarNotifyReviewOffer = $.pkp.controllers.form.coarNotifyReviewOffer || {};
     ...
     */
    $.pkp.controllers.form.coarNotifyReviewOffer.CoarNotifyReviewOfferFormHandler = function ($formElement, options) {
    ...
    $.pkp.classes.Helper.inherits(
        $.pkp.controllers.form.coarNotifyReviewOffer.CoarNotifyReviewOfferFormHandler,
